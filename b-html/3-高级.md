...
<img src="https://raw.githubusercontent.com/hughxusu/lesson-web/developing/_images/b-html/Xnip2024-08-06_11-51-55.jpg" style="zoom:50%;" />
...
<form action="/my-handling-form-page" method="post">
  ...
  <p>
    申请职位：<br>
    <label>
      <input type="radio" name="gender" checked>前端开发
    </label>
    <label>
      <input type="radio" name="gender" checked>服务端开发
    </label>
  ...
  <p>
    ...
    <label>
      <input type="checkbox" checked>html/css/javascript
    </label>
  </p>
  <p>
    工作方式：<br>
