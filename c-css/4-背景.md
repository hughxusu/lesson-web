...
<style>
  div {
    width: 400px;
    height: 400px;
    background: pink url('https://raw.githubusercontent.com/hughxusu/lesson-web/developing/_src/material/bg.png') no-repeat 20px center/contain;
  }
</style>
<div></div>
```
...
<img src="https://raw.githubusercontent.com/hughxusu/lesson-web/developing/_images/c-css/pPvWqXT.jpg" style="zoom:35%;" />
