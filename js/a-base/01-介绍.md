...
<img src="../../_images/d-js/pSRy1b9.jpg" style="zoom:60%;" />

JavaScript是由Brendan Eich（布兰登·艾克）在1995年推出。

<img src="../../_images/d-js/brendan-eich-mozilla-firefox-square.0.1467740722.jpg" style="zoom: 25%;" />
...
<img src="../../_images/d-js/js-frame.png" style="zoom: 70%;" />
...
JavaScript是一门解释型语言（脚本语言），需要通过解析引擎，对JavaScript的代码进行解析与执行。V8引擎是由Google公司使用C++开发的一种高性能的 JavaScript引擎，用于 Chrome 浏览器的 JavaScript 解析。V8 引擎是一款开源软件。
...
<img src="../../_images/d-js/l5slbacchravc_66c399ffdd6e4e818543f5de7a57631e.webp" style="zoom:60%;" />
...
<img src="../../_images/d-js/l5slbacchravc_b6f4782b214f4f26a3850a2ace987d92.webp" style="zoom:61%;" />
