...
<script>
    const pomes = document.querySelectorAll('.pome');
    ...
    for (let i = 0; i < pomes.length; i++) {
        ...
        li.innerHTML = `
            <a href="javascript:" id="${i}">
                ${pomes[i].querySelector('h2').innerText}
            </a>
        `;
        nav.appendChild(li);
    }
    ...
    nav.addEventListener('click', function (event) {
        ...
        if (target.tagName === 'A') {
            document.documentElement.scrollTop = pomes[target.id].offsetTop
        }
    });
</script>
```
...
<img src="../../../images/d-js/Xnip2025-11-05_10-49-30.jpg" style="zoom:45%;" />
...
<script>
    let index = 0
    let path = 'https://raw.githubusercontent.com/hughxusu/lesson-web/develop/res/silder/'
    let arr = [
        'naz1.jpg', 'naz2.jpg', 'naz3.jpg', 'naz4.jpg', 'naz5.jpg', 'naz6.jpg', 'naz7.jpg'
    ]
    let bar = document.querySelector('.box .bar')
    ...
    function changeImg() {
        ...
        let a = bar.querySelector('a.active')
        a.classList.remove('active')
        a = bar.children[index]
        a.classList.add('active')
    }
    changeImg()
...
* `<a href="javascript:" class="prev"> < </a>`这里`href="javascript:"`阻止了链接的默认行为。
