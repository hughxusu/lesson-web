...
<div>
  <button>
    显示二维码
		<img src="https://raw.githubusercontent.com/hughxusu/lesson-web/develop/images/material/bg.png" alt="">
  </button>
</div>
```
...
项目中将多张小图片，合并成一张大图片，这张大图片称之为[精灵图](https://raw.githubusercontent.com/hughxusu/lesson-web/refs/heads/develop/images/material/taobao.png)。精灵图可以减少服务器发送次数，减轻服务器的压力，提高页面加载速度。
...
<style>
    span {
        ...
        width: 18px;
        height: 24px;
        background-image: url(https://raw.githubusercontent.com/hughxusu/lesson-web/refs/heads/develop/images/material/taobao.png);
